export const projects = [
  {
    title: 'AI Chatbot',
    description: 'An AI-powered chatbot with natural language processing capabilities.',
  ...
  export const educationData = [
    {
      ...
      duration: '2023 - 2025',
      description: '',
      logo: '/klu.png', // Adjust the path as necessary
    },
    {
      ...
      duration: '2019 - 2023',
      description: '',
      logo: '/nri.png', // Adjust the path as necessary
    },
  ];
/***********************Education ***************************/  
